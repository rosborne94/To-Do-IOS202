...
class ToDoTableViewController: UITableViewController {
    ...
    var headerNames = ["Home", "Work", "Fitness", "Other"]
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return ToDoStore.shared.getCount(section)
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.setupCell(ToDoStore.shared.getToDo(indexPath.section, indexPath.row))
    ...
    */
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCellEditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            ...
            ToDoStore.shared.deleteToDo(indexPath.section, indexPath.row)
    ...
    @IBAction func saveNoteDetail (_ segue: UIStoryboardSegue) {
        ...
        if let indexPath = tableView.indexPathForSelectedRow {
           // ToDoStore.shared.sort()
            ...
            ToDoStore.shared.addToDo(toDoDetailVC.toDo.category, toDoDetailVC.toDo)
